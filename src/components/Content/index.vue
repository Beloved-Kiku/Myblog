<template>
<KeepAlive>
    <n-tabs type="card" @update:value="handleUpdateValue" :default-value="defaultValue">
    <n-tab-pane v-for="x in result" :key="x.id" :tab="x.article_title" :name="x.article_title">
